...
?>">
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                    <input type="http://localhost/joomla3.9/" class="form-control form-control-dark" placeholder="Search...">
                </form>
	...
	<!-- Footer -->
    <footer class="bg-dark text-center text-white position-relative" style="
    bottom: 0;
